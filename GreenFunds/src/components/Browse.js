...
import bg from '../UI/monitorBg.png'
          ...
          <div className={styles.grad}>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-4" >
                ...
                <a href="/">
                  ...
                  <div class="row" style={{marginLeft: 42}}>
                    <a href="/browse" class="btn btn-outline-success col-3" style={{height: 100, width: 40, backgroundImage: "url(" + monitor + ")", backgroundPosition: 'center', backgroundSize: "contain",
                    backgroundRepeat: 'no-repeat', resizeMode: 'contain', margin: 6,
                    borderRadius: 10, boxShadow: "0px 0px 5px #D2D3D8"}}>
                    </a>
              ...
              backgroundRepeat: 'no-repeat', resizeMode: 'contain'}}>
                  ...
                  style={{paddingTop:80, paddingLeft: 40}}>Monitor</div>

                  <p className={styles.desc}
                  style={{paddingTop:20, paddingLeft: 40, paddingRight: 30}}>
                    Making use of the transparency of transactions in the blockchain, this section can be used for monitoring fund activies. Auditors, members of public,
                    civil authorities and enviornmental activists can use our Monitor feature to keep tab on movement of Green Funds - making the issuing authority accountable
                    for their promises.
                  </p>
                  ...
                  { this.state.funds.map((fund, key) => {
                        ...
                        <div className="card border-danger mb-3" style={{marginTop:0, paddingTop: 2}} key={key} >
                            ...
                            <li key={key} className="list-group-item py-2">
                                ...
                                <p></p>
                                <small className="text-muted">Claims: {(fund.organisation.toString())}</small>
                            </li>
                            {/* <li key={key} className="list-group-item py-2">
